...
public class ServletBorrarCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletBorrarCliente</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Se ha eliminado al cliente "+nombre+" con identificacion "+cedula+", correo: "+correo+" y telefono "+telefono+"</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
